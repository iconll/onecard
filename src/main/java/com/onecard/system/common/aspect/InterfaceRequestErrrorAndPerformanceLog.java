package com.onecard.system.common.aspect;

import com.google.common.base.Stopwatch;
import com.google.common.collect.Lists;
import com.onecard.system.common.util.ApiResponse;
import com.onecard.system.common.util.IllegalStrFilterUtil;
...
public class InterfaceRequestErrrorAndPerformanceLog {
    ...
    @Pointcut("execution(* com.onecard.system.sys.controller.*.*.*(..))")

...
import com.kmut.retail.entity.OutboundBack;
import com.kmut.retail.entity.OutboundDetail;
import com.kmut.retail.repo.GoodsRepo;
import com.kmut.retail.repo.OutboundBackRepo;
import com.kmut.retail.repo.OutboundDetailRepo;
import com.kmut.retail.repo.OutboundRepo;
...
public class OutboundBackService extends BaseService {
    ...
    public BaseResponse cancel(Integer backId){
        ...
        if(outboundDetail==null){
            ...
            outboundDetail.setMerchantUser(back.getMerchantUser());
